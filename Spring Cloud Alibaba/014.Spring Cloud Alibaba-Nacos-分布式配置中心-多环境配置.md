...
此处我们以之前创建的 [**服务提供者**](/zh/spring-cloud-alibaba/创建服务提供者.html#创建服务提供者) 项目为例

### 在 Nacos Server 中增加配置

增加一个名为 `nacos-provider-config-prod.yaml` 的配置

![](/assets/Lusifer_20190111041121.png)
...
![](/assets/Lusifer_20190111043201.png)

- 设置需要激活的配置

![](/assets/Lusifer_20190111043322.png)

- 观察日志，判断是否成功加载配置

![](/assets/Lusifer_20190111043538.png)